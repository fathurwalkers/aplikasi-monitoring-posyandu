...
@section('main-content-body')
    ...
    <div class="card mb-2">
        <div class="card-body">
            <form action="{{ route('post-tambah-balita') }}" method="POST">
                @csrf

                <div class="form-group mb-2">
                    <label for="balita_nama" class="text-bold h6"><strong><h6 class="mb-0">Nama Balita :</h6></strong></label>
                    <input type="text" class="form-control" id="balita_nama" aria-describedby="" placeholder="Masukkan Nama Balita..." name="balita_nama">
                ...
                <div class="form-group mb-2">
                    ...
                    <select class="form-control" id="balita_jeniskelamin" name="balita_jeniskelamin">
                        <option value="null" selected disabled>Pilih Jenis Kelamin</option>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="date" class="form-control" id="balita_ttl" aria-describedby="" name="balita_ttl">
                    {{-- <small id="" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                </div>

                <div class="form-group mb-2">
                    <label for="balita_nik" class="text-bold"><strong><h6 class="mb-0">NIK : </h6></strong></label>
                    <input type="number" class="form-control" id="balita_nik" aria-describedby="" placeholder="Masukkan NIK..." name="balita_nik">
                    {{-- <small id="" class="form-text text-muted">We'll never share your email with anyone else.</small> --}}
                </div>

                <div class="form-group mb-2">
                    <label for="balita_nama_ortu" class="text-bold"><strong><h6 class="mb-0">Nama Orang Tua : </h6></strong></label>
                    <input type="text" class="form-control" id="balita_nama_ortu" aria-describedby="" placeholder="Masukkan nama ibu..." name="balita_nama_ortu">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="balita_provinsi" aria-describedby="" placeholder="Masukkan nama provinsi..." name="balita_provinsi">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="balita_kota" aria-describedby="" placeholder="Masukkan asal kota / Kabupaten..." name="balita_kota">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="balita_kecamatan" aria-describedby="" placeholder="Masukkan Kecamatan..." name="balita_kecamatan">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="balita_puskesmas" aria-describedby="" placeholder="Masukkan puskesmas..." name="balita_puskesmas">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="balita_desa" aria-describedby="" placeholder="Masukkan desa..." name="balita_desa">
                    <small id="" class="form-text text-muted">Contoh : Wolio</small>
                </div>

                <div class="form-group mb-2">
                    <label for="balita_posyandu" class="text-bold"><strong><h6 class="mb-0">Posyandu : </h6></strong></label>
                    <input type="text" class="form-control" id="balita_posyandu" aria-describedby="" placeholder="Masukkan posyandu..." name="balita_posyandu">
