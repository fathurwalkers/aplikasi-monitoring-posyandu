...
@section('title', 'Ubah Data Bidan')

@push('css')

@endpush

@section('main-content-header', 'Ubah Data Bidan')

@section('main-content-body')

    <div class="card mb-2">
        <div class="card-body">
            <form action="{{ route('post-ubah-bidan', $bidan->id) }}" method="POST">
                @csrf

                <div class="form-group mb-2">
                    <label for="bidan_nama" class="text-bold h6"><strong><h6 class="mb-0">Nama :</h6></strong></label>
                    <input type="text" class="form-control" id="bidan_nama" aria-describedby="" placeholder="Masukkan Nama Bidan..." name="bidan_nama" value="{{ $bidan->bidan_nama }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="bidan_sipb" aria-describedby="" placeholder="Masukkan SIPB Bidan..." name="bidan_sipb" value="{{ $bidan->bidan_nama }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="bidan_alamat" aria-describedby="" placeholder="Masukkan Alamat Bidan..." name="bidan_alamat" value="{{ $bidan->bidan_nama }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="number" class="form-control" id="bidan_telepon" aria-describedby="" placeholder="Masukkan No. HP / Telepon Bidan..." name="bidan_telepon" value="{{ $bidan->bidan_telepon }}">
                    {{-- <small id="" class="form-text text-muted">Contoh : Muh. Nabil Zulaiman</small> --}}
                </div>
