...
@section('title', 'ubah Jadwal Posyandu')

@push('css')

@endpush

@section('main-content-header', 'ubah Jadwal Posyandu')

@section('main-content-body')

    <div class="card mb-2">
        <div class="card-body">
            <form action="{{ route('post-ubah-jadwal', $jadwal->id) }}" method="POST">
                @csrf
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="nama_posyandu" aria-describedby="emailHelp" placeholder="Masukkan nama posyandu..." name="nama_posyandu" value="{{ $jadwal->nama_posyandu }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="alamat_posyandu" aria-describedby="emailHelp" placeholder="Masukkan alamat posyandu..." name="alamat_posyandu" value="{{ $jadwal->alamat_posyandu }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="date" class="form-control" id="tanggal_posyandu" aria-describedby="emailHelp"  name="tanggal_posyandu" value="{{ $jadwal->tanggal_posyandu }}">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" id="kecamatan_posyandu" aria-describedby="emailHelp" placeholder="Masukkan tempat posyandu..." name="kecamatan_posyandu" value="{{ $jadwal->kecamatan_posyandu }}">
